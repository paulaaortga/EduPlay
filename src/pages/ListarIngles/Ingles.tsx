...
export default function ListadoActividadesMates() {
  ...
  useEffect(() => {
    const fetchActividades = async () => {
      try {
        const response = await axios.get("http://localhost:3001/asignatura/Inglés");
  ...
  return (
    <div className="listadoI-container">
      <h2 className="listadoI-title">Actividades de Inglés</h2>

      <table className="tabla-actividadesI">
        <thead>
