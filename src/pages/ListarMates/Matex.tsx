...
export default function ListadoActividadesMates({ onVolver }: { onVolver: () => void }) {
  ...
  useEffect(() => {
    const fetchActividades = async () => {
      try {
        const response = await axios.get("http://localhost:3001/asignatura/Matemáticas");
  ...
  return (
    <div className="listadoM-container">
      <h2 className="listadoM-title">Actividades de Matemáticas</h2>

      <table className="tabla-actividadesM">
        <thead>
